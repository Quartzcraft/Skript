...
import uk.co.quartzcraft.skript.events.EvtClick;
...
public abstract class SkriptEvent implements SyntaxElement, Debuggable {
	...
	@Override
	public final boolean init(final uk.co.quartzcraft.skript.lang.Expression<?>[] vars, final int matchedPattern, final Kleenean isDelayed, final ParseResult parseResult) {
