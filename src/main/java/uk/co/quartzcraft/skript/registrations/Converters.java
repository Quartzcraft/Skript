...
import uk.co.quartzcraft.skript.classes.ChainedConverter;
import uk.co.quartzcraft.skript.classes.Converter;
import uk.co.quartzcraft.skript.classes.Converter.ConverterInfo;
import uk.co.quartzcraft.skript.classes.Converter.ConverterUtils;
...
public abstract class Converters {
	...
	@Deprecated
	public static <F, T> void registerConverter(final Class<F> from, final Class<T> to, final uk.co.quartzcraft.skript.classes.SerializableConverter<F, T> converter) {
	...
	@Deprecated
	public static <F, T> void registerConverter(final Class<F> from, final Class<T> to, final uk.co.quartzcraft.skript.classes.SerializableConverter<F, T> converter, final int options) {
